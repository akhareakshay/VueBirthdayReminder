<template>
  <div class="container">
    <div class="w-75" style="margin-top: -20%;margin-right: 10%;">
      <h3 class="text-center mb-4" style="font-size: 3rem;color: var(--themeColor)">Register User</h3>

      <div class="mx-auto" style="width:90%">
        <form class="w-50 mx-auto" v-on:submit.prevent="signUp()">
          <div class="ips mb-4 d-flex align-items-center px-3">
            <i class="ml-2 fa fa-user" aria-hidden="true" style="font-size: 1.4rem;"></i>
                <input class="form-control w-100 border-0 bg-transparent"
                  type="text"
                  v-model="username"
            ...
            <div class="ips mb-4 d-flex align-items-center px-3">
              <i class="fa fa-mobile" aria-hidden="true" style="font-size: 1.7rem;padding-left: 10px;"></i>
            <input
              type="number"
              required
              v-model="phonenumber"
          ...
          <div class="ips mb-4 d-flex align-items-center px-3">
              ...
              style="font-size: 1.1rem; padding-left:8px "></i> 
          <input
            type="email"
            v-model="email"
            placeholder="Email"
          ...
          <div class="ips mb-4 d-flex align-items-center px-3" style="position: relative">
            <i class="ml-2 fa fa-lock mt-1" aria-hidden="true" style="font-size: 1.4rem;"></i>
          <input
            ...
            required
          />
          <button class="eyeiconbtn border-0 bg-transparent"
          ...
          <button type="submit" class="signupbtn btn w-100">Sign Up</button>
          <br />
          <br />
          <div class="w-100">
            Do you already have an account ?
          <router-link class="links pl-1" to="/">Login</router-link>
          </div>
        </form>
      </div>
    </div>
    <div class="top-0 w-100 h-100" style="position:fixed; z-index: -1;left: 15%">
      ...
      >
        ...
        <g>
          ...
          <path
            d="m433.61,91.85c-3.73-.11-6.18-3.88-7.63-7.32-1.45-3.44-2.94-7.39-6.4-8.81-2.83-1.16-7.82,6.69-10.05,4.6-2.33-2.18-.06-13.37,2.41-15.38,2.47-2.01,5.85-2.4,9.03-2.55,7.76-.36,15.57.27,23.18,1.86,4.71.98,9.55,2.46,12.95,5.86,4.3,4.32,5.4,10.83,5.71,16.92.32,6.23-.04,12.75-3.07,18.2-3.03,5.45-9.37,9.47-15.45,8.08-.61-3.3.01-6.69.25-10.05.23-3.35-.01-6.97-2.06-9.64-2.04-2.67-6.42-3.73-8.8-1.36"
            fill="#2f2e43"
          />
          <path
            d="m461.02,99.57c2.23-1.63,4.9-3,7.64-2.66,2.96.36,5.47,2.8,6.23,5.69.76,2.89-.09,6.07-1.93,8.43-1.83,2.36-4.56,3.92-7.44,4.7-1.67.45-3.5.64-5.09-.04-2.34-1.01-3.61-4-2.69-6.38"
            fill="#2f2e43"
          />
          <g>
            <path
              id="uuid-7c51491a-a3f2-4b96-8a09-2fdcda15a35d-58"
              d="m375.76,309.2c-1.49,7.32,1.24,14.01,6.08,14.94,4.84.93,9.97-4.26,11.45-11.58.63-2.92.53-5.94-.29-8.82l18.43-114.75-23.05-4.34-8.9,116.5c-1.89,2.36-3.16,5.12-3.72,8.06h0Z"
              fill="#9f616a"
            />
            <path
          ...
          />
          <path
            d="m455.11,241.91h-58.63l-5.32,54.54,23.28,201.52h29.93l-11.97-116.39,48.55,105.08,26.6-18.62-37.91-98.1s13.54-85.46,2.9-106.75c-10.64-21.28-17.43-21.28-17.43-21.28Z"
            fill="#2f2e43"
          />
          <polygon
          ...
          />
          <path
            id="uuid-407a3abe-f78b-4b20-8293-778f9eb8e749-59"
            d="m492.66,309.2c1.49,7.32-1.24,14.01-6.08,14.94-4.84.93-9.97-4.26-11.45-11.58-.63-2.92-.53-5.94.29-8.82l-18.43-114.75,23.05-4.34,8.9,116.5c1.89,2.36,3.16,5.12,3.72,8.06h0Z"
            fill="#9f616a"
          />
          <path
