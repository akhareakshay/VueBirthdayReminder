<template>
  <div class="d-flex align-items-center p-4" style="height: 100vh">
    <!-- <h1>HEy Sampi</h1> -->
    <div class="col-12 col-md-7 d-flex align-items-center h-100" style="padding-left: 100px">
    ...
    >
      ...
      <path
        ...
        fill="#e6e6e6"
      />
      <circle cx="51.38142" cy="296.31007" r="9.4144" fill="#536dfe" />
      <path
        ...
        fill="#e6e6e6"
      />
      <circle cx="45.76935" cy="316.05762" r="6.10756" fill="#536dfe" />
      <path
        ...
        fill="#e6e6e6"
      />
      <circle cx="19.8347" cy="315.62888" r="6.10756" fill="#536dfe" />
      <path
    ...
    <form class="col-12 col-md-3" style="padding-left: 60px;margin-left: 50px">
    <h1 class="text-center mb-4" style="font-size: 3rem;margin-left: -20px; color: var(--themeColor)">User Login</h1>
    <br />
    <div class="ips mb-4 d-flex align-items-center px-3">
      <i class="ml-2 fa fa-user" aria-hidden="true" style="font-size: 25px;"></i>
      <input class="form-control w-75 border-0 bg-transparent" type="text" placeholder="User name" v-model="username" />
    </div>
    <div style="position:relative" class="ips mb-4 d-flex align-items-center px-3">
      <i class="ml-2 fa fa-lock mt-1" aria-hidden="true" style="font-size: 25px;"></i>
      <input class="form-control w-75 border-0 bg-transparent" :type="showPassword ? 'text' : 'password'" placeholder="Password" v-model="password" />
      ...
      <button class="loginbtn btn w-100" type="submit" @click.prevent="login()">Login</button><br /><br />
      <router-link class="links btn w-100" to="/Signup">Signup</router-link>
    </form>
  </div>
</template>
